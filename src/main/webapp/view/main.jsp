        ...
        <div class="container-fluid preview-bl">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-10 col-lg-8 main-header-text">
                    ...
                    <p class="prev-sub-text">Over 10 years of experience. During our existence, we have significantly improved our service. It is no surprise that the number of our clients is increasing every year.</p>
                </div>
    ...
    <div class="container">
        <div id="car-list" class="row car-container">
            <c:forEach items="${list}" var="car">
                <div class="car-item flex-item col-lg-4 col-md-6 col-sm-12" data-sort-in="${car.carLvlId}">
                    <div id="car-bl-item">
                        ...
                        <div class="car-btn">
                            <c:choose>
                                <c:when test="${sessionScope.customer != null}">
                                    <a class="btn btn-warning rent-btn" href="<%=request.getContextPath()%>/view/carInfo.jsp?carId=${car.carId}">
                                        RESERVE
                                    </a>
                                </c:when>
                                <c:when test="${sessionScope.customer == null}">
